...
module.exports = function(config, mongoClient) {
  ...
  return {
/**
 * Whether groupId shared data with userId
 */
...
/**
 * List of users that groupId is sharing data with
 */
...
/**
 * List of users that shared data with userId
 */
...
/**
 * Create/Update/Delete permission for userId to see groupId's data
 */
    setPermissions: function(userId, groupId, permissions, cb) {
      ...
      // Silently ignore any attempt to give root privileges to a user.
