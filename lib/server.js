...
/**
 * @api {get} /status Request Service Status with software version
 * @apiName Status
 * @apiGroup Health-Check
 *
 * @apiSuccess {Object} status The status of the service
 * @apiSuccess {string} status.status The status of the service i.e. OK
 * @apiSuccess {string} status.version The semver version of the service
...
/**
 * @api {get} /access/status Request Service Basic Status
 * @apiName BasicStatus
 * @apiGroup Health-Check
 *
 * @apiSuccess {Object} status The status of the service
 * @apiSuccess {string} status.status The status of the service e.g. OK
 * @apiSuccess {string} status.version The semver version of the service
 */
